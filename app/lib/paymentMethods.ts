...
export function getManualPaymentMethods (orderId: string, totalCents: number): ManualPaymentMethod[]
{
  ...
  return [
    ...
    },
    {
      ...
      paymentUrl: null,
      note: "Send the exact amount shown (network fees are separate).",
    },
  ];
}

export function buildPaymentInstructionsText (orderId: string, totalCents: number): string
{
