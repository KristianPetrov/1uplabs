...
const createPubChemMoleculeDefinition = (
    slug: string,
    displayName: string,
    source: Extract<MoleculeStructureSource, { type: "pubchem" }>,
    options: { subtitle?: string; fallbackSource?: MoleculeStructureSource } = {}
): MoleculeDefinition => ({
    slug,
    displayName,
    subtitle: options.subtitle,
...
const canonicalMolecules = {
    bpc157: createLocalMoleculeDefinition("bpc-157", "BPC-157", {
        fallback: pubchemSource("9941957", { queryType: "cid" }),
    }),
    tb500: createLocalMoleculeDefinition("tb-500", "TB-500 (Thymosin β4)", {
        fallback: pubchemSource("62707662", { queryType: "cid" }),
    }),
    ghkCu: createLocalMoleculeDefinition("ghk-cu", "GHK-Cu", {
        // PubChem 3D SDF is available for CID 73587. CID 378611 serves 2D SDF.
        // Local file is preferred; fallback keeps an online option if the asset is missing.
        fallback: pubchemSource("378611", { queryType: "cid" }),
    }),
...
export const moleculesByProduct: MoleculeMap = {
    ...
    // ],
    Glutathione: [
        createLocalMoleculeDefinition("glutathione", "Reduced Glutathione", {
    ...
    "MOTS-C": [
        createLocalMoleculeDefinition("mots-c", "MOTS-c", {
            fallback: pubchemSource("146675088", { queryType: "cid", recordType: "2d" }),
        }),
    ],
    "NAD+": [
    ...
    Retatrutide: [
        createLocalMoleculeDefinition("retatrutide", "Retatrutide", {
            fallback: pubchemSource("171390338", { queryType: "cid", recordType: "2d" }),
        }),
    ],
    Selank: [
    ...
    Tesamorelin: [
        createLocalMoleculeDefinition("tesamorelin", "Tesamorelin", {
            fallback: pubchemSource("16137828", { queryType: "cid", recordType: "2d" }),
        }),
    ],
    Tirzepatide: [
        createLocalMoleculeDefinition("tirzepatide", "Tirzepatide", {
            fallback: pubchemSource("166567236", { queryType: "cid", recordType: "2d" }),
        }),
    ],
    GLOW: [
        withMolecule(canonicalMolecules.bpc157, {
