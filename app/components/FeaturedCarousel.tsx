  ...
  return (
    <div className="mt-8">
      <div className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-5 sm:p-6">
        <div className="pointer-events-none absolute -right-16 -top-16 h-44 w-44 rounded-full bg-sky-500/0 blur-3xl transition [transition-duration:700ms] group-hover:bg-sky-500/15" />
