...
export default function CopyField ({ label, value }: Props)
{
  return (
    <motion.div
      ...
      className="opaque-panel group relative overflow-hidden rounded-2xl border border-white/12 p-4"
    >
      ...
      <div className="mt-2 flex items-center justify-between gap-3">
        <code className="opaque-field min-w-0 truncate rounded-xl px-3 py-2 text-sm text-white">
          {value}
        </code>
        <CopyButton
          text={value}
